...
return array(
	...
	'html2canvas'                         => array(
		'title'     => esc_html__( 'HTML2Canvas library', 'xstore' ),
		'name'      => 'html2canvas',
		'file'      => '/js/libs/html2canvas.min.js',
		'version'   => '1.4.1',
		'deps'      => array(),
		'in_footer' => [
			'in_footer' => true,
	...
	'jspdf'                               => array(
		'title'     => esc_html__( 'jsPDF library', 'xstore' ),
		'name'      => 'jspdf',
		'file'      => '/js/libs/jspdf.umd.min.js',
		'version'   => '2.5.1',
		'deps'      => array(),
		'in_footer' => [
			'in_footer' => true,
	...
	'xstore-pdf-print-product'            => array(
		'title'     => esc_html__( 'Product PDF print', 'xstore' ),
		'name'      => 'xstore-pdf-print-product',
		'file'      => '/js/modules/pdfPrintProduct.min.js',
		'deps'      => array( 'jquery', 'html2canvas', 'jspdf' ),
		'in_footer' => [
			'in_footer' => true,
			'strategy'  => 'defer'
		]
