...
add_filter( $hook, function ( $fields ) use ( $woocommerce_sidebars, $sep_style ) {
    ...
    $args = array(
        ...
        'category_breadcrumbs_below_banner' => array(
            'name'            => 'category_breadcrumbs_below_banner',
            'type'            => 'toggle',
            'settings'        => 'category_breadcrumbs_below_banner',
            'label'           => esc_html__( 'Breadcrumbs below category description', 'xstore' ),
            'tooltip'         => esc_html__( 'Move breadcrumbs below the category description or static block on product category pages.', 'xstore' ),
            'section'         => 'shop-page',
            'default'         => 0,
            'active_callback' => array(
                array(
