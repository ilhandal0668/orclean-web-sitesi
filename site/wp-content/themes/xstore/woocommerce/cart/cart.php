    ...
    <form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
        ...
        <div class="table-responsive">
            <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
                <thead>
                <tr>
                    <th scope="col" class="product-details" colspan="2"><?php esc_html_e( 'Product', 'xstore' ); ?></th>
                    <th scope="col" class="product-price mob-hide"><?php esc_html_e( 'Price', 'xstore' ); ?></th>
                    <?php if ( $show_sku_field ) : ?>
                        <th scope="col" class="product-sku mob-hide"><?php esc_html_e( 'SKU', 'xstore' ); ?></th>
                    <?php endif; ?>
                    <th scope="col" class="product-quantity mob-hide"><?php esc_html_e( 'Quantity', 'xstore' ); ?></th>
                    <th scope="col" class="product-subtotal mob-hide" colspan="2"><?php esc_html_e( 'Subtotal', 'xstore' ); ?></th>
                </tr>
                </thead>
                <tbody>
                                ...
                                <div class="cart-item-details">
                                    ...
                                    <div class="product-remove">
                                        ...
                                        echo apply_filters( 'woocommerce_cart_item_remove_link',
                                            sprintf(
                                                '<a role="button" href="%s" class="remove-item text-underline" title="%s">%s</a>',
