...
<?php 
	...
	$promo_text_package_default = array(
		array(
	...
	$element_options['promo_text_package'] = get_theme_mod( 'promo_text_package', $promo_text_package_default );
	if ( ! is_array( $element_options['promo_text_package'] ) ) {
		$element_options['promo_text_package'] = $promo_text_package_default;
	}
