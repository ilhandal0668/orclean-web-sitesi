...
//		'select_menu_extra'      => esc_html__( 'Select Extra Tab Menu', 'xstore-core' ),
        ...
        'padding'                => esc_html__( 'Padding', 'xstore-core' ),
...
//		'editor_control'         => esc_html__( 'This is an editor control.', 'xstore-core' ),
    ...
    'description'     => array(
        ...
        'padding'               => esc_html__( 'Set the padding for this element. Leave a value empty to inherit the desktop setting.', 'xstore-core' ),
        'paddings'               => array(
            'padding-top'    => esc_html__( 'Padding top', 'xstore-core' ),
            'padding-right'  => esc_html__( 'Padding right', 'xstore-core' ),
            'padding-bottom' => esc_html__( 'Padding bottom', 'xstore-core' ),
...
$box_models['padding_empty']                 = array(
    'padding-top'    => '',
    'padding-right'  => '',
    'padding-bottom' => '',
    'padding-left'   => '',
...
function box_model_output( $selector, $properties = array() ) {
    if ( ! $properties ) {
        $properties = array(
            'margin-top',
            'margin-right',
