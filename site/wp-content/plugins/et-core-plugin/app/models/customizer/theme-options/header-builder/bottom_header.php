...
add_filter( 'et/customizer/add/fields/bottom_header', function ( $fields ) use ( $separators, $strings, $choices, $box_models ) {
	...
	$args = array(
		...
		'bottom_header_box_model_et-mobile' => array(
			'name'      => 'bottom_header_box_model_et-mobile',
			'settings'  => 'bottom_header_box_model_et-mobile',
			'label'     => $strings['label']['padding'],
			'tooltip'   => $strings['description']['padding'],
			'type'      => 'dimensions',
			'section'   => 'bottom_header',
			'default'   => $box_models['padding_empty'],
			'choices'   => array(
