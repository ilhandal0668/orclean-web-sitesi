...
add_filter( 'et/customizer/add/fields/search', function ( $fields ) use ( $separators, $strings, $choices, $sep_style, $sidebars_with_inherit, $box_models ) {
    ...
    $search_product_fields_default = array(
        'title',
        'content',
        'excerpt',
    );

    // Preserve the existing SKU setting until the new field list is saved.
    if ( get_theme_mod( 'search_by_sku_et-desktop', 1 ) ) {
        $search_product_fields_default[] = 'sku';
    }
...
//		),
        ...
        'search_results_content_et-desktop'               => array(
            ...
            'type'        => 'sortable',
            'label'       => esc_html__( 'Search content types', 'xstore-core' ),
        ...
        'search_product_fields_et-desktop'                => array(
            'name'            => 'search_product_fields_et-desktop',
            'type'            => 'sortable',
            'settings'        => 'search_product_fields_et-desktop',
            'label'           => esc_html__( 'Product search fields', 'xstore-core' ),
            'tooltip'         => esc_html__( 'Choose which product fields are used to find matching products. Disable unnecessary fields to make search results more precise.', 'xstore-core' ),
            'section'         => 'search',
            'default'         => $search_product_fields_default,
            'choices'         => array(
