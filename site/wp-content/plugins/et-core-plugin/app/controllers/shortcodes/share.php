...
class Share extends Shortcodes {
	...
	public static function share_shortcode( $atts, $content = null ) {
		...
		extract(shortcode_atts(array(
			...
			'pdf' =>  in_array( 'share_pdf', $socials ),
		...
		if($pdf == 1) {
			...
			$pdf_class = trim( str_replace( 'copy-to-clipboard', '', $tooltip_class ) );
			$html .= '
			<li>
			<a href="#" class="'.$pdf_class.' xstore-share-pdf" title="'.__('PDF', 'xstore-core').'" role="button">
			<i class="et-icon et-file"></i>'.
			($tooltip ? '<span class="mt-mes">'.__('PDF', 'xstore-core').'</span>' : '').
			'</a>
			</li>
			';
		}
