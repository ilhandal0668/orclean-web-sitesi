...
if ( ! function_exists( 'add_action' ) ) {
	...
	/*
	 * The "Extended Product Title" and "Attribute Mapping" cards were parked
	 * before release and are intentionally absent from this list; see the file
	 * history if they need to be restored.
	 */
	$woo_feed_features     = array(
		array(
			'thumb'       => esc_url( WOO_FEED_PLUGIN_URL ) . 'V8/Admin/images/feature-smart-filter-thumbnail.svg',
			'title'       => 'Smart Filter',
		...
		array(
			'thumb'       => esc_url( WOO_FEED_PLUGIN_URL ) . 'V8/Admin/images/feature-advanced-filter-thumbnail.svg',
		...
		array(
			'thumb'       => esc_url( WOO_FEED_PLUGIN_URL ) . 'V8/Admin/images/feature-exclude-include-categories-thumbnail.svg',
		...
		array(
			'thumb'       => esc_url( WOO_FEED_PLUGIN_URL ) . 'V8/Admin/images/feature-exclude-include-products-thumbnail.svg',
		...
		array(
			'thumb'       => esc_url( WOO_FEED_PLUGIN_URL ) . 'V8/Admin/images/feature-out-of-stock-thumbnail.svg',
			'title'       => 'Out of Stock',
		...
		array(
			'thumb'       => esc_url( WOO_FEED_PLUGIN_URL ) . 'V8/Admin/images/feature-variations-thumbnail.svg',
			'title'       => 'Variations',
		...
		array(
			'thumb'       => esc_url( WOO_FEED_PLUGIN_URL ) . 'V8/Admin/images/feature-auto-update-interval-thumbnail.svg',
			'title'       => 'Auto Update',
		...
		array(
			'thumb'       => esc_url( WOO_FEED_PLUGIN_URL ) . 'V8/Admin/images/feature-string-replace-thumbnail.svg',
		...
		array(
			'thumb'       => esc_url( WOO_FEED_PLUGIN_URL ) . 'V8/Admin/images/feature-multi-language-support-thumbnail.svg',
		...
		array(
			'thumb'       => esc_url( WOO_FEED_PLUGIN_URL ) . 'V8/Admin/images/feature-multi-currency-thumbnail.svg',
		...
		array(
			'thumb'       => esc_url( WOO_FEED_PLUGIN_URL ) . 'V8/Admin/images/feature-dynamic-attributes-thumbnail.svg',
		...
		array(
			'thumb'       => esc_url( WOO_FEED_PLUGIN_URL ) . 'V8/Admin/images/feature-dynamic-pricing-thumbnail.svg',
		...
		array(
			'thumb'       => esc_url( WOO_FEED_PLUGIN_URL ) . 'V8/Admin/images/feature-multi-vendors-thumbnail.svg',
		...
		array(
			'thumb'       => esc_url( WOO_FEED_PLUGIN_URL ) . 'V8/Admin/images/feature-custom-template-2-thumbnail.svg',
		...
		array(
			'thumb'       => esc_url( WOO_FEED_PLUGIN_URL ) . 'V8/Admin/images/feature-number-format-thumbnail.svg',
			'title'       => 'Number Format',
...
<div class="wrap wapk-admin wapk-feed-pro-upgrade">
	<div class="wapk-section wapk-feed-banner">
		<div class="wapk-banner">
			<a href="https://webappick.com/plugin/woocommerce-product-feed-pro/?utm_source=freePlugin&utm_medium=go_premium&utm_campaign=free_to_pro&utm_term=wooFeed" target="_blank">
				<img class="wapk-banner__graphics" src="<?php echo esc_url( WOO_FEED_PLUGIN_URL ); ?>V8/Admin/images/woo-feed-pro-banner.png" alt="<?php esc_attr_e( 'Upgrade to WooFeed Pro to unlock more powerful features.', 'woo-feed' ); ?>">
			</a>
		</div>
	</div>
	<div class="clear"></div>
	<div class="wapk-section wapk-feed-features">
		<div class="wapk-feed-feature__list">
			<?php foreach ( $woo_feed_features as $woo_feed_feature ) { ?>
			<div class="wapk-feed-feature__item">
				<div class="wapk-feed-feature__thumb">
					<img src="<?php echo esc_url( $woo_feed_feature['thumb'] ); ?>" alt="<?php echo esc_attr( $woo_feed_feature['title'] ); ?>" title="<?php echo esc_attr( $woo_feed_feature['title'] ); ?>">
				</div>
				<div class="wapk-feed-feature__description">
					<h3><?php echo wp_kses( $woo_feed_feature['title'], $woo_feed_allowed_html ); ?></h3>
					<p><?php echo wp_kses( $woo_feed_feature['description'], $woo_feed_allowed_html ); ?></p>
				</div>
				<div class="wapk-feed-feature__links">
					<a target="_blank" rel="noreferrer" href="<?php echo esc_url( $woo_feed_feature['more-link'] ); ?>"><?php esc_html_e( 'Learn More', 'woo-feed' ); ?></a>
				</div>
			</div>
			<?php } ?>
		</div>
			...
			<div class="wapk-feed-buy-now-wrapper">
				<div class="wapk-feed-buy-now-product-container">
					<div class="wapk-feed-buy-now-thumbnail">
						<img src="<?php echo esc_url( WOO_FEED_PLUGIN_URL ); ?>images/woo-feed-icon.svg" alt="CTX Feed Pro" />
					</div>
					<div class="wapk-feed-buy-now-title">
						<div class="wapk-feed-buy-now-product-name"><?php esc_html_e( 'CTX Feed Pro', 'woo-feed' ); ?></div>
						<div class="wapk-feed-buy-now-price">
							<span class="from"><?php esc_html_e( 'From: ', 'woo-feed' ); ?></span>
							<span class="woocommerce-Price-amount amount">
						<bdi><span class="woocommerce-Price-currencySymbol"><?php esc_html_e( '$ ', 'woo-feed' ); ?></span><?php esc_html_e( '119.00', 'woo-feed' ); ?></bdi>
					</span>
							<span class="subscription-details"><?php esc_html_e( '/ year', 'woo-feed' ); ?></span>
						</div>
					</div>
					<div class="wapk-feed-buy-now-product-description"><?php esc_html_e( 'CTX Feed Pro is the most optimized &amp; error-free WooCommerce product feed manager that makes your product listing approved faster, [...]', 'woo-feed' ); ?></div>
				</div>
